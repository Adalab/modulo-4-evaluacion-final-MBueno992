...
server.get('/libros', async (req, res) => {
  try {
    ...
    const librosSQL =
      'SELECT libros.titulo, libros.genero, libros.año, libros.editorial, libros.precio, autores.nombre AS autor FROM libros INNER JOIN autores ON libros.fk_autorId = autores.idAutor';
